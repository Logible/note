...
conda create --name video_env python=3.10
...
CUDA_VISIBLE_DEVICES=0,1,2 python run_dataparallel.py --config config/vox_serve.yaml --device_ids 0,1,2 --name DaGAN_model --rgbd --batchsize 48 --kp_num 15 --generator DepthAwareGenerator
