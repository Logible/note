...
2. 翻译步骤
   ...
   3. 词义推敲(以段为单位进行哟)
         1. 词义选择. 根据单词本来的意思,用中  国人的语言将它通顺地表达出来, 如
            1. elegant system;
            2. elegant skin;
            3. elegant life;
         2. 词序调整
         3. 词性转化
            ...
            2. we should put emphasis on the issure
            3. Analysis of the culture now and past;
         4. 增词法
            1. 翻译中抽象名词通常需要增词, 化抽象为具体
            2. Look into the past and report their findings sonn.
            3. 科学家们正在研究**宇宙**的过去
            4. Children will play with dolls equipped with personality chips, computers with in-built personalities
               1. 带有内置芯片/个性/装备/软件
   4. 检查核对
