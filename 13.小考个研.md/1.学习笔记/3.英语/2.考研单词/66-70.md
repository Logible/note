...
2. **rules** her life; The Supreme Court has yet to **rule** on the case_1;
3. a wise **ruler**;
...
11. swing-swung-swung;
    ...
    2. playing on the **swings**_1; get into the swing of it_1;
...
5. an **auxiliary** nurse; a nursing **auxiliary**;
6. Centigrade;
7. catch the **culprit**;
8. ccused of **dubious** accounting practices; dubious about - doubtful;
9. Any money **due**; **is due on** 31 January; **due** regard;
10. three years’ **duration**;
11. an **extinct** species;
12. **extinguish** all cigarettes;
13. in **mysterious** circumstances; - mystery
14. the **norm**; norms; become the **norm**;
15. misguided **notions** of male superiority;
