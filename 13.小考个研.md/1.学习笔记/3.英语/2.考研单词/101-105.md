...
- a doctor, straddled by a skeleton![straddled](https://upload.wikimedia.org/wikipedia/commons/thumb/e/ef/A_doctor%2C_straddled_by_a_skeleton%2C_holds_a_full_purse_in_his_hands_Wellcome_V0011676.jpg/1200px-A_doctor%2C_straddled_by_a_skeleton%2C_holds_a_full_purse_in_his_hands_Wellcome_V0011676.jpg)
...
3. snap-v.
   ...
   3. ‘What do you want?’ Mike **snapped**_1.
   ...
   6. A light **snapped** on in one of the huts_3.
...
2. ceiling
   1. a public spending **ceiling** of £240 billion
   2. rooms with high **ceilings**
3. ego
   1. Richard has the biggest **ego** (=thinks he is very clever and important) of anyone I’ve ever met.
   2. a fragile **ego**
4. harvest
   1. every year **at harvest time**
   2. Plum growers are expecting a bumper **harvest** this year.
   3. The company is now **reaping the harvest** of careful planning.
5. bay
   1. a house with a view across the **bay**
   2. a storage **bay**;loading **bay**
   3. the cargo **bay**
6. the **advent** of the computer
7. the **cell** structure
   1. red blood **cells**
   2. He spent a night in the **cells** at the local police station.
   3. Call me on my **cell** if you’re running late.
   4. a car powered by electric fuel **cells**
   5. a terrorist **cell**
   6. the **cells** of a honeycomb
8. cement
   1. a bag of **cement**
   2. They want to **cement a** good working **relationship** between the government and trade unions.
9. **censorship** of books
10. a traffic census and statistics Department
    1. a traffic **census**
11. tremble
    1. Greene was on his feet now, his body **trembling with rage**.
    2. I **tremble** to think what will happen when she finds out.
12. trial
    1. The **trial** is due to start next week.
    2. a new drug that is undergoing clinical **trials**
    3. They let me have the computer **on trial** for thirty days.
    4. I learned most of what I know about gardening **through trial and error**.
    5. the daily **trials** of living in a poor country
    6. sheepdog **trial**
    7. These techniques were **trialled** by teachers in 300 schools.
13. herd
    1. You have to be an individual; it’s no use running with **the herd**.
    2. It was Tom’s duty to **herd** the cows.
    3. something is like **herding** cats
...
- ceiling![ceiling](https://i.ytimg.com/vi/hdI5FKCIU10/maxresdefault.jpg)
...
- census and statistics Department![census and statistics Department](https://www.censtatd.gov.hk/iconset/21C_EN.png)
- harvest![harvest](https://upload.wikimedia.org/wikipedia/commons/b/b0/Agriculture_in_Volgograd_Oblast_002.JPG)
- bay![bay](https://upload.wikimedia.org/wikipedia/commons/e/ec/Hanauma_Bay.JPG)
- storage bay,loading bay![storage bay](https://www.researchgate.net/profile/Chang-Xu-26/publication/262246582/figure/fig1/AS:392529359982594@1470597700140/Loading-bay-left-and-storage-bay-right.png)
- cargo bay![cargo bay](https://media.defense.gov/2016/Jan/06/2001332610/-1/-1/0/151222-F-XD880-161.JPG)
- why are Honeycomb Cell Hexagonal![why are Honeycomb Cell Hexagonal](https://www.sciencefriday.com/wp-content/uploads/2017/08/Beehive-micro_large-min.jpg)
- why do we tremble when Afraid![why do we tremble when Afraid](https://faqbite.com/wp-content/uploads/2017/11/tremble-thumb-1.png)
- sheepdog trial![sheepdog trial](https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/BC_eye.jpg/360px-BC_eye.jpg)
- herding dog![Herding dog](https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Kelpie_walking_across_the_backs_of_sheep.jpg/330px-Kelpie_walking_across_the_backs_of_sheep.jpg)
