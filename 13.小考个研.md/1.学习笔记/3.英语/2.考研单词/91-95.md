...
4. The hotel has its own pool and leisure **facilities**.
   ...
   2. a top-secret research **facility**_1;
...
6. jail-gaol
7. Ollie **gasped** with pain and slumped forward.
   1. Brendan climbed slowly, **gasping** for breath.
...
4. The boss expects us to be able to **change gear** just like that.
   1. United **stepped up a gear** in the second half_1.
   2. He’s crazy about photography – he’s got **all the gear**.
5. The typical career pattern **was geared to men** whose wives didn't work.;
   1. The organization is **gearing up** for a convention in May.
...
9. Heavy snowfalls brought traffic to a **halt**;
   1. The government has failed to **halt** economic decline.
   2. The whole peace process seems to **have ground to a halt**.
