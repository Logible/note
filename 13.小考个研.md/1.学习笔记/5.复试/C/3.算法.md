...
- 在 C 语言中，如果要比较一个 double 类型的数和一个 int 类型的数，会先将 int 类型的数转换为 double 类型，然后再进行比较。因此，按照 double 类型比较。
...
- 08 continue在switch的作用(其实是对应上层的作用<image style="height:500px; background-color:#CDDEC2" src="https://raw.githubusercontent.com/Logible/Image/main/note_image/20230305152526.png"/>
