...
- $low<=high$而不是$low<high$的原因
  - ![20220921214133](https://raw.githubusercontent.com/Logible/Image/main/note_image/20220921214133.png)
  - ![20220921214154](https://raw.githubusercontent.com/Logible/Image/main/note_image/20220921214154.png)
- 查找失败情况(因为low的左边都比关键字小,high的右边都比关键字大,low>high,说明关键字不存在)
  - ![20220921214352](https://raw.githubusercontent.com/Logible/Image/main/note_image/20220921214352.png)
...
3. 判定树
   ...
   2. 从判定树可以看出
      ...
      5. 判定树是一棵**平衡二叉树**。
   3. 判定树的编号是固定的⭐
      1. $mid=\lfloor (low+high)/2 \rfloor$,则右子树结点数$-$左子树结点数$=0/1$;
      2. ![判定树的编号](https://raw.githubusercontent.com/Logible/Image/main/note_image/20220901222622.png)

4. Average Search Length⭐⭐⭐平均查找长度等于$\lceil log_2(n+1)\rceil$?
...
- 分块查找
  - 查找成功![20220921221638](https://raw.githubusercontent.com/Logible/Image/main/note_image/20220921221638.png)
  - 查找失败![20220921221605](https://raw.githubusercontent.com/Logible/Image/main/note_image/20220921221605.png)

1. 分块查找
   1. 又称**索引顺序查找**，它吸取了顺序查找和折半查找各自的优点，既有动态结构，又适于快速查找。
...
3. Average Search Length
   1. ASL具体计算:![20220921222300](https://raw.githubusercontent.com/Logible/Image/main/note_image/20220921222300.png)
   2. 分块查找的平均查找长度为索引查找和块内查找的平均长度之和。
      1. 设索引查找和块内查找的平均查找长度分别为$L_1,L_s$，则分块查找的平均查找长度为
         $\displaystyle ASL=L_1+L_S$
   3. 将长度为n的查找表均匀地分为b块，每块有s个记录，在等概率情况下，若在块内和索引表中均采用顺序查找，则平均查找长度(查找成功)

      $\displaystyle ASL=L_1+L_S=\frac{b+1}{2}+\frac{s+1}{2} = \frac{s^2+2s+n}{2s}$

      此时,若$s=\sqrt{n}$,则平均查找长度**最小值**为$\sqrt{n}+1$

   4. 若对索引表采用折半查找时，则平均查找长度为
...
- 072013真题 为什么可以用二叉排序树![20220929220355](https://raw.githubusercontent.com/Logible/Image/main/note_image/20220929220355.png)

字符串比较时, 先比较其ASCII编码, 再比较其长度

⭐⭐

- 02画漏了![20220929214741](https://raw.githubusercontent.com/Logible/Image/main/note_image/20220929214741.png)

## 真题

- 2013![20221109222138](https://raw.githubusercontent.com/Logible/Image/main/note_image/20221109222138.png)
  - 开放题 并不一定要最优
  - ![20221109222224](https://raw.githubusercontent.com/Logible/Image/main/note_image/20221109222224.png)
