...
上卖弄这些$\color{#ea4335}{get*}$方法返回的都是当前时区的时间,$\color{#ea4335}{Date}$对象还提供了这些方法对应的UTC版本,用来返回UTC时间
...
上述代码,本时区(东八时区)的1月6日0点0分,是UTX时区的前一天下午16点.设为UTC时区的22点以后,就变成本地时区的上午6点
